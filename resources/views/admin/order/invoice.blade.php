    ...
    <div class="invoice-box">
        <table>
            <tr class="top">
                <td colspan="4">
                    <table>
                        <tr>
                            <td class="title">
                                <img src="{{asset('/')}}website/img/unnamed.png" alt="Company logo" style="width: 100%; max-width: 250px" />
                            </td>
            ...
            <tr class="total">
                <td colspan="3"></td>
                <td>Coupon Discount: ৳{{number_format($order->coupon_discount_price)}}</td>
            </tr>
            ...
            <tr class="total">
                <td colspan="3"></td>
                <td>Total Payable: {{number_format(($sum  + $order->shipping_total - $order->coupon_discount_price))}}</td>
            </tr>
        </table>
    </div>
